...
function draw (mesh,camera,state) {
  return {
    ...
    `,
    uniforms: Object.assign(camera.members('proj'), widths, {
...
exports.draw = function (regl, mesh, camera, state) {
  ...
  var drawLines = regl(dmerge(draw(mesh,camera,state), opts, {
    uniforms: Object.assign({ expand: 0 }, colors)
  }))
  var drawBorders = regl(dmerge(draw(mesh,camera,state), opts, {
